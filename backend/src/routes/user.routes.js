...
const { checkRole, requireCanModifyTarget, preventRoleEscalation } = require('../middleware/roleCheck');
const {
 ...
 */
router.post('/', checkRole(['admin', 'supervisor']), preventRoleEscalation, createUserValidation, userController.createUser);
 ...
 *         description: No autorizado
 */
router.put('/:id', checkRole(['admin', 'supervisor']), requireCanModifyTarget, preventRoleEscalation, updateUserValidation, userController.updateUser);
 ...
 *         description: Acceso denegado
 */
router.delete('/:id', checkRole(['admin', 'supervisor']), requireCanModifyTarget, userIdValidation, userController.deleteUser);
 ...
 *         description: No autorizado
 */
router.post('/:id/activate', checkRole(['admin', 'supervisor']), requireCanModifyTarget, userIdValidation, userController.activateUser);
 ...
 *         description: No autorizado
 */
router.post('/:id/deactivate', checkRole(['admin', 'supervisor']), requireCanModifyTarget, userIdValidation, userController.deactivateUser);
 ...
 *         description: No autorizado
 */
router.post('/:id/unlock', checkRole(['admin', 'supervisor']), requireCanModifyTarget, userIdValidation, userController.unlockUser);
